...
class BasicSimulation extends Simulation {
  ...
  val TEST_DURATION: Int = Option(System.getenv("TEST_DURATION"))
    ...
    .getOrElse(1)
  val TARGET_SERVER: String = Option(System.getenv("TARGET_SERVER"))
    .getOrElse("demo.funky-functor.com:8080")

  System.err.println(s"Running test for $TEST_DURATION minutes against $TARGET_SERVER")
